...
import "./FamousToken.sol";
import "../node_modules/@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol";

contract FamousTokenSale {
    string public name = "Famous";
    ...
    address payable private ethFunds =
        payable(0x161eeAc6848595480D369aD876748d7d6bbD74a0);
    FToken public token;
    ...
    constructor(FamousToken _token) {
    ...
    function famousTokenPriceInETH() public view returns (int256) {
    ...
    function buyToken(uint256 _amount) public payable {
        int256 famousTokenPriceETH = famousTokenPriceInETH();
        // Check that the buyer sends the enough ETH
        require(int256(msg.value) >= famousTokenPriceETH * int256(_amount));
